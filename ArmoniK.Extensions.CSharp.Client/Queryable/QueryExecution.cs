...
internal abstract class QueryExecution<TPage, TSource, TField, TEnumField, TFilterOr, TFilterAnd, TFilterField>
  where TField : new()
  ...
  where TFilterAnd : new()
{
  ...
  protected abstract Pagination<TFilterOr, TField>
    CreatePaginationInstance(QueryExpressionTreeVisitor<TSource, TEnumField, TFilterOr, TFilterAnd, TFilterField> visitor);
